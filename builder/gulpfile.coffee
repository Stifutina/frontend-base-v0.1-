...
gulp.task 'stylus', ->
	gulp.src config.paths.src.styles.pages
	.pipe g.plumber
		errorHandler: consoleErorr
	.pipe g.stylus()
...
gulp.task 'watch', ->
	...
	gulp.watch [config.paths.src.styles.parts.blocks, config.paths.src.styles.parts.common,
				config.paths.src.styles.parts.helpers], ['styles:min']
